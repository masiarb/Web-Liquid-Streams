...
/*
	Writes a yellow message on the screen.
...
var idleInterval;
/*
	This method is deprecated, use createOperator instead.
	Assign the callback function of the "reply" given as
	parameter to the actual callback of the operator.
	
	@param {function} func      : The callback function
	@param {boolean}  automatic : Boolean value that sets if the script has to be executed manually or not (usually set from command line interface)
*/
...
/*
	Assign the callback function of the "reply" given as
	parameter to the actual callback of the operator.
	This is an alias to createNode, which is now deprecated.
	
	@param {function} func      : The callback function
	@param {boolean}  automatic : Boolean value that sets if the script has to be executed manually or not (usually set from command line interface)
*/
exports.createOperator = exports.createNode;

/*
	Assign the callback function of the "reply" given as
	parameter to the actual callback of the operator. Used to create
	an operator that joins two streams.
...
/*
	Deprecated.
	Set this as a particular operator key.
	
	@param {Object} key : The global key of state
*/
...
/*
	Deprecated, the start happens when the operator start receiving data.
...
/*
	...
	@param {String} id : The id of the message received.
*/
...
/*
	...
	@param {Object} message : The message to be sent downstream.
	@param {Object} options : Optional parameter specifying sending options (Deprecated).
	@param {String} id      : Id used for the execution flag, not used anymore (Deprecated).
*/
...
/*
*	send_partition takes care of sending messages partitioning the 
...
exports.sendContentBased = function(message, options){
	...
	try {
	    ...
	    console.log("ERROR in send_content_based function: " + e)
	}
}

/*
	The SendTo function provides an easy way to send data
	directly to a certain Operator ID. This goes against the
	purpose of a streaming topology, so it is suggested not to be used.
	
	@param {Object} message : The message to be sent.
	@param {String} to      : The recipient of the message (id).
*/
exports.sendTo = function(message, to){
	...
	try {
		...
		console.log("ERROR in sentTo function: " + e );
	}
}
...
/*
	This send function sends the message to *all* the operators 
	connected to this operator. This function can be called directly
	from the script, but it is highly suggested to specify the 
	sending algorithm in the topology description file.
...
/*
	...
	@private
	@param {Number} mex_received   : Number of messages sent to a Worker
	@param {Number} total_mex_sent : Total number of messages sent by this Worker
*/
...
/*
	This send function sends the message to all the *workers* 
	connected to this operator, one at a time. Ideally, it sends messages to
	one worker at a time for each operator connected to this one.
	This function can be called directly from the script, 
	but it is highly suggested to specify the sending algorithm 
	in the topology description file.
...
/*
	...
	Receives a list of flags containing the workers executing.
	If they are all true, it means they are all working, thus no worker
	can be killed (yet).
	
	@private
	
	@param {Array} flags : Array of booleans representing the execution of workers.
*/
...
/*
	Function that removes a value from an array without 
	leaving a trailing 'undefined'.
	
	@private
	@param {Array} array        : The array to be modified.
	@param {Object} deleteValue : The value to be removed.
*/
...
/*
	...
	The function checks if the worker is currently idle.
	Currently the function is commented (graceful_kill()).
...
/*
	Graceful suicide handling for processes.
	Computes the idleness of the process in order to establish its idleness.
...
/*
	Returns the rough size in bytes of an object.
	
	@private
	
	@param {Object} object : The object we need to know the size.
*/
