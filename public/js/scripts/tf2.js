...
// 	var modu = mod((result),3);
 	...
 	//k.storage.incrBySortList('twitlist{'+uid+'}', 1, str);
 	//k.stateful("incrBySortList", 'twitlist{'+uid+'}', 1, str, function(r){console.log("res incremented::"+r) })
 	k.stateful("set", ["foo","bar"], function(r){console.log("SET::"+r) })
 	//k.stateful("get", ["foo"], function(r){console.log("GOT::"+r) })
