...
k.createNode(function(msg, uid) {
 ...
 //    	}
//	 });
//	 console.log(start + ' - ' + msg_id + ' - ' + delay + ' - ' + y + " - " + x + " - " + timeBetweenMessages + " - " + uid + "\n")
	 ...
	 //fs.appendFileSync("time_table.txt", msg_id + ' - ' + start + ' - ' + workersInFilter + ' - ' + time_enter_filter + ' - ' + time_exit_filter + " - " + now + "\n", encoding='utf8', function(err) {
     	...
     	//}
	 //});
//	 console.log(msg_id + ' - ' + start + ' - ' + workersInFilter + ' - ' + time_enter_filter + ' - ' + time_exit_filter + " - " + now + "\n")


	console.log(start + "-" + msg_id  + "-"  + delay + "-" + y + "-" + x + "-" + timeBetweenMessages + "-" + from  + "-" + time_enter_filter + "-" + time_exit_filter)
